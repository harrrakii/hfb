...
namespace Practical_5._Calendar
{
    ...
    public partial class ChoicePage : Page
    {
        ...
        private void InitializeListOfChoices()
        {
            ...
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Ебнуть пивка", Icon = (new Uri("../../../images/pivo.png", UriKind.Relative)) });
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Хряпнуть водочки", Icon = (new Uri("../../../images/vodka.png", UriKind.Relative)) });
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Кровавая мери, которую Скорогудаева гововит в шарике", Icon = (new Uri("../../../images/scorogudaeva.png", UriKind.Relative)) });
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Запить яблочный виски огуречным рассолом", Icon = (new Uri("../../../images/viskey.png", UriKind.Relative)) });
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Пригубить винца", Icon = (new Uri("../../../images/vino.png", UriKind.Relative)) });
            choice_points_list.Add(new ChoicePoint { ChoiceName = "Закусить лимончиком", Icon = (new Uri("../../../images/limon.png", UriKind.Relative)) });
            ...
            ListBx.ItemsSource = choice_points_list;
        }
        ...
        private void ListBox_SelectionChanged(object sender, SelectionChangedEventArgs e) { ListBx.SelectedIndex = -1; }
    }
}
